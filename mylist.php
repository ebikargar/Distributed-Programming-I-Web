...
if(islogin())
{
	//$query = "SELECT distinct P2RID from relation  where P1RID='".$_SESSION['email']."' ";
	$query = "SELECT * from tblreservation  where 	UserId = '".$_SESSION['UserId']."'  ORDER BY StartSeedIndex ";
	if ($result = $db->query($query)) 
	{
		...
		while ($elm= mysqli_fetch_array($result))
		{
			...
			echo '<td><a href="javascript:show_confirm('.$elm['ResId'].');">Delete</td>';
			//<a href="delete.php?resId='. $elm['ResId'] . '">Delete</td>';
			echo '</tr>';
